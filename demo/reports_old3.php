      ...
      <div class="row">
        ...
        <tbody>
          <?php 
           ...
           $sql = "SELECT * from reminder r INNER JOIN reminder_participants rp ON r.rem_id=rp.rem_id INNER JOIN rating rat ON rat.rem_id=r.rem_id and rat.userid=rp.userid WHERE $priority AND $statusfilter AND $date_range AND $par AND r.activity!='De' GROUP BY r.rem_id order by r.Status DESC, r.from_date desc  ";
