    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Search Remider Task</h3>
        ...
        <div class="col-12">
         <div class="box ">
            ...
            <div class="box-body ">
              ...
              <table id="example1" class="table table-bordered table-striped table-condensed table-responsive" width="100%">
                <thead>
        ...
        <tbody>
          <?php 
            ...
            if (isset($_REQUEST['from_date']) && $_REQUEST['from_date']!='' && isset($_REQUEST['to_date']) && $_REQUEST['to_date']!='' && isset($_REQUEST['priority']) && $_REQUEST['priority']!='') 
            {
                ...
                if ($_SESSION['utype']=="A")
                {
                    $sql = "SELECT * FROM reminder WHERE activity='A' AND priority='$priority' AND  date(from_date) BETWEEN '$from_date' AND '$to_date'  ";
                }
                else
                {
                    $sql = "SELECT * FROM reminder WHERE activity='A' AND priority='$priority' AND  date(from_date) BETWEEN '$from_date' AND '$to_date' AND created_by=".$_SESSION['id'];
                }
            ...
            else if (isset($_REQUEST['from_date']) && $_REQUEST['from_date']!='' && isset($_REQUEST['to_date']) && $_REQUEST['to_date']!='') 
            {
                ...
                if ($_SESSION['utype']=="A")
                {
                    $sql = "SELECT * FROM reminder WHERE activity='A' AND date(from_date) BETWEEN '$from_date' AND '$to_date'  ";
                }
                else
                {
                    $sql = "SELECT * FROM reminder WHERE activity='A' AND date(from_date) BETWEEN '$from_date' AND '$to_date' AND created_by=".$_SESSION['id'];
                }
            ...
            else if (isset($_REQUEST['priority']) && $_REQUEST['priority']!='') 
            {
                ...
                if ($_SESSION['utype']=="A")
                {
                    $sql = "SELECT * FROM reminder WHERE activity='A' AND priority='$priority' ";
                }
                else
                {
                    $sql = "SELECT * FROM reminder WHERE activity='A' AND priority='$priority' AND created_by=".$_SESSION['id'];
                }
            }
            else if (isset($_REQUEST['from_date']) && $_REQUEST['from_date']!='' && isset($_REQUEST['to_date']) && $_REQUEST['to_date']!='' && isset($_REQUEST['priority']) && $_REQUEST['priority']!='' && isset($_REQUEST['par']) && $_REQUEST['par']!='' && $_SESSION['utype']=="A") 
            {
                ...
                $priority = $_REQUEST['priority'];
                $par = $_REQUEST['par'];
                $sql = "SELECT * FROM `reminder_participants` INNER JOIN `reminder` ON reminder_participants.rem_id = reminder.rem_id WHERE reminder_participants.userid=$par AND reminder.activity='A' ";
            }
            ...
            else
            {
              if ($_SESSION['utype']=="A")
                ...
                {
                    $sql = "SELECT * from reminder r INNER JOIN reminder_participants rp ON r.rem_id=rp.rem_id WHERE r.activity='A' AND (r.created_by='".$_SESSION['id']."' || rp.userid='".$_SESSION['id']."' ) GROUP BY r.rem_id";
                }
            ...
            <?php
            $r=$row['rem_id'];
              echo "<td><a href='reports.php?id=$r' title='View Reminder Detail' href=''><img src='images/view.png'></a></td>";
              echo "<td>".$row['type']."</td>";
              echo "<td>".$row['title']."</td>";
              echo "<td>".$row['location']."</td>";
              if ($row['rem_req']==1) {echo "<td>Yes</td>";}else{echo "<td>No</td>";}
              if ($row['priority']=="KMedium"){echo "<td>Medium</td>";}else{echo "<td>".$row['priority']."</td>";}
              ...
              echo "<td>".$row1['ufname']." ".$row1['ulname']."</td>";
              ...
              if ($row['Status']=="Pending"){echo "<td><span class=' badge bg-red'>Pending<span></td>";}else{echo "<td><span class=' badge bg-green'>Done<span></td>";}
