...
include "config.php";
$sql = "SELECT * FROM notification WHERE date(not_time)=CURDATE() AND DATE_FORMAT(not_time,'%H:%i:%s') BETWEEN CURRENT_TIME AND ADDTIME(CURRENT_TIME,'2:00:00') ";
...
while ($row = mysql_fetch_assoc($result1)) 
{
	...
	while ($row2 = mysql_fetch_assoc($result2)) 
	{
		...
		$test = "0";
		$sender = "REMIND";
		$message = "Your Reminder App Registration Verification OTP Code is valid for 10 Minutes and Verification OTP Code is '123'";
