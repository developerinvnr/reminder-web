...
?>       
        <div class="col-md-12 col-lg-<?php if($totn==1){echo 12;}elseif($totn==2){echo 6;}elseif($totn==3){echo 4;}elseif($totn==4){echo 3;}else{echo 6;} ?>" style="margin-top:-20px; padding:0px;">
          <div class="box box-default">
           ...
           <b style='color:<?php if($row2['priority']=='Low'){echo "blue";}elseif($row2['priority']=='KMedium'){echo "blue";}else{echo "#FFFF00";} ?>;font-size:12px;'>Deadline : </b><span style="color: <?php if($row2['priority']=='Low'){echo "black";}elseif($row2['priority']=='KMedium'){echo "black";}else{echo "white";} ?>;font-size:12px;"><?=date('d-M', strtotime($row2['to_date']))?> <?=date('y  h:i A', strtotime($row2['to_date']))?></span>,
...
?>       
        <div class="col-md-12 col-lg-<?php if($totn==1){echo 12;}elseif($totn==2){echo 6;}elseif($totn==3){echo 4;}elseif($totn==4){echo 3;}else{echo 6;} ?>" style="margin-top:-20px;padding:0px;">
          <div class="box box-default">
           ...
           <b style='color:000;font-size:12px;'>Deadline : </b><span style="color:#0076EC;font-size:12px;"><?=date('d-M', strtotime($row22['to_date']))?> <?=date('y  h:i A', strtotime($row22['to_date']))?></span>,
...
?>          
        <div class="col-md-12 col-lg-<?php if($totn==1){echo 12;}elseif($totn==2){echo 6;}elseif($totn==3){echo 4;}elseif($totn==4){echo 3;}else{echo 6;} ?>" style="margin-top: -20px;padding:0px;">
          <div class="box box-default">
            ...
            <b style='color:<?php if($row1['priority']=='Low'){echo "blue";}elseif($row1['priority']=='KMedium'){echo "blue";}else{echo "#FFFF00";} ?>;font-size:12px;'>Deadline : </b><span style="color: <?php if($row1['priority']=='Low'){echo "black";}elseif($row1['priority']=='KMedium'){echo "black";}else{echo "white";} ?>;font-size:12px;"><?=date('d-M', strtotime($row1['to_date']))?> <?=date('y H:i A', strtotime($row1['to_date']))?></span>
...
?>          
        <div class="col-md-12 col-lg-<?php if($totn==1){echo 12;}elseif($totn==2){echo 6;}elseif($totn==3){echo 4;}elseif($totn==4){echo 3;}else{echo 6;} ?>" style="margin-top: -20px;padding:0px;">
          <div class="box box-default">
            ...
            <b style='color:#0076EC;font-size:12px;'>Date : </b><span style="color: #000;font-size:12px;"><?=date('d-M', strtotime($row11['from_date']))?> <?=date('y H:i A', strtotime($row11['from_date']))?></span>,
            
            &nbsp;
            
            <b style='color:#0076EC;font-size:12px;'>Deadline : </b><span style="color: #000;font-size:12px;"><?=date('d-M', strtotime($row11['to_date']))?> <?=date('y H:i A', strtotime($row11['to_date']))?></span>
            
            <br> <b style='color:#0076EC; font-size:12px;'>For : </b>
            <?php 
                    ...
                    <a  href='home.php?t=dltc&id=<?=$rowdl['rem_id']?>'>
                      ...
                      <p style="padding: 2px;" class='card-text' style='font-size:10px; margin-top:-10px;'>
                        ...
                        <span class="pull-right" style="width: 35%;">
                          ...
                          <b style='color:#00264d;font-size:12px;font-weight: bold !important'>Deadline : </b>
                          <span style="color: #000;font-size:12px;">
                            <?=date('d-M', strtotime($rowdl['to_date']))?> <?=date('y H:i A', strtotime($rowdl['to_date']))?>
                          </span>
      ...
      <div class="modal-footer">
        ...
        if($_GET['t']=='mtp'){ 
          ...
          if ($Status=='Pending' && $created_by==$_SESSION['id']){
            ...
            <button type="submit" id="save_button" class="btn btn-primary float-right align-self-center" style="display:none;">Update</button>
